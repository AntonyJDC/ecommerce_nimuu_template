...
import { newArrivalsData, relatedProductData, topSellingData } from "../../pages/Home/HomePage";
          ...
          <div className="flex flex-col w-full space-y-5 px-3">
            <div className="flex flex-col lg:flex-row lg:justify-between">
              ...
              <div className="flex flex-col sm:items-center sm:flex-row">
                <span className="text-sm md:text-base text-base-content/60 mr-3">
                  Showing 1-10 of 100 Products
                </span>
                <div className="flex items-center">
                  Sort by:{" "}
                  <Select defaultValue="most-popular">
                    <SelectTrigger className="font-medium text-sm px-1.5 sm:text-base w-fit text-base-content bg-transparent shadow-none border-none">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
